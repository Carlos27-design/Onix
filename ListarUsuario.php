...
$listaTiposUsuarios = $tipoUsuarioDB->listar();
?>
...
<body class="home-two">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="contact-area">
                                    <form action="IngresarNuevoUsuario.php">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php
                                        foreach ($listaTiposUsuarios as $ltu) {
                                            if ($l->tipoUsuario_id == $ltu->id) {
                                        ?>
                                                <?php echo "<td>" . $ltu->nombre . "</td>" ?>
                                        <?php
                                            }
                                        }
                                        ?>
                                        <td>
                                            <a title="Editar" href="EditarMiPerfil.php?id=<?php echo $l->id; ?>" class="btn"><i class="fas fa-edit"></i></a>
    ...
    <script>
        function deleteItem(id) {
            ...
            if (ask) {
                window.location.href = "ActEliminarUsuario.php?id=" + id;
