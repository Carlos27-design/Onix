                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="quote-form-area wow fadeIn">
                        ...
                        <form class="quote-form" action="ActRegistrarUsuario.php" method="post">
                            <p class="width-full">
                                <input type="text" name="txtRut" id="txtRut" placeholder="RUT">
                            </p>
                            <p class="width-half">
                                <input type="text" name="txtNombre" id="txtNombre" placeholder="Nombre">
                                <input class="pull-right" type="text" name="txtApellido" id="txtApellido" placeholder="Apellido">
                            </p>
                            <p class="width-full">
                            ...
                            <p class="width-half">
                                <input type="number" name="txtNroTelefonico" id="txtNroTelefonico" placeholder="N° Telefono">
                                <input class="pull-right" type="password" name="txtContrasena" id="txtContrasena" placeholder="Contraseña">
                            </p>
