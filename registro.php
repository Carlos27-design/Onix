...
<body class="home-two">
    ...
    <!--ABOUT AREA-->
    <section class="about-area -bg section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="quote-form-area wow fadeIn">
                        ...
                        <form class="quote-form" action="ActRegistrarUsuario.php" method="post">
                            ...
                            <p class="width-half">
                                <input required type="number" name="txtNroTelefonico" id="txtNroTelefonico" placeholder="N° Telefono" maxlength="10">
                                <input required class="pull-right" type="password" name="txtContrasena" id="txtContrasena" placeholder="Contraseña" maxlength="20">
                            </p>
