...
<body class="home-two">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="contact-area">
                                    <form action="IngresarModelo.php">
                                        <button class="btn" type="submit"><i class=" fas fa-plus-square"></i> Agregar Modelo</button>
                                    </form>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?>
                                        <td>
                                            <a title="Editar" href="EditarModelo.php?id=<?php echo $l->id; ?>" class="btn"><i class="fas fa-edit"></i></a>
    ...
    <script>
        function deleteItem(id) {
            ...
            if (ask) {
                window.location.href = "ActEliminarModelo.php?id=" + id;
