...
<body class="home-two">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="contact-area">
                                    <form action="IngresarTipoUsuario.php">
                                        <button class="btn" type="submit"><i class=" fas fa-plus-square"></i> Tipo de usuario </button>
                                    </form>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Editar" href="EditarTipoUsuario.php?id=<?php echo $l->id; ?>" class="btn"><i class="fas fa-edit"></i></a>
    ...
    <script>
        function deleteItem(id) {
            ...
            if (ask) {
                window.location.href = "ActEliminarTipoUsuario.php?id=" + id;
